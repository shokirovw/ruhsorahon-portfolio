...
function ImageComponent ({ url }) {
    return (
        <Image src={url} width={400} height={300} className='transition-all w-full h-full object-cover rounded-xl' style={{ objectPosition: "50% 50%" }}  />
    );
}
		...
		<div className='w-full bg-white'>
      		<div className='w-full bg-[#c9b284] overflow-hidden min-h-screen'>
      			<div className={`container max-w-4xl mx-auto min-h-[92vh] pt-7 pb-16 px-8 md:pt-16 lg:px-16 mx-auto`}>
		            <h1 className='text-5xl lg:text-7xl text-center'>{article_data.title}</h1>
